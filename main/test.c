...
#define EXAMPLE_ESP_WIFI_SSID      "esp32_wifi_ap"
#define EXAMPLE_ESP_WIFI_PASS      "12345678"
#define EXAMPLE_ESP_WIFI_CHANNEL   6
#define EXAMPLE_MAX_STA_CONN       4

#define STA_SSID                   "iLAB"
#define STA_PASS                   "interlab"
                                    ...
                                    int32_t event_id, void* event_data)
{
    ...
    ESP_LOGI(TAG, "Event fired %d", event_id);

    if (event_id == WIFI_EVENT_STA_START) {
        ESP_LOGI(TAG, "Trying to connect sta");
        esp_wifi_connect();
